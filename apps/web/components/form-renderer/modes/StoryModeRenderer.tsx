...
export function StoryModeRenderer({ schema, disabled = false, engine }: ModeRendererProps) {
 ...
 const simpleInputTypes = new Set<string>(["text", "short_text", "long_text", "name", "email", "number", "phone", "tel", "textarea", "date", "file", "password", "time", "datetime", "color", "range", "url", "hidden"]);
 ...
 if (["text","short_text","long_text","name","email","number","phone","tel","textarea","date","file"].includes(field.type)) {
 ...
 email: "email", number: "number", phone: "tel", tel: "tel",
