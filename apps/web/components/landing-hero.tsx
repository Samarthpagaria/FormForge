...
const DYNAMIC_WORDS: DynamicWordInfo[] = [
  {
    word: "Noise",
    gradientClass: "from-emerald-500 via-teal-500 to-cyan-500 dark:from-emerald-400 dark:via-teal-400 dark:to-cyan-400",
  },
  {
    word: "Friction",
    gradientClass: "from-orange-500 via-amber-500 to-rose-500 dark:from-orange-400 dark:via-amber-400 dark:to-rose-400",
  },
  {
    word: "Chaos",
    gradientClass: "from-violet-500 via-purple-500 to-indigo-500 dark:from-violet-400 dark:via-purple-400 dark:to-indigo-400",
  },
  {
    word: "Overhead",
    gradientClass: "from-blue-500 via-sky-500 to-indigo-500 dark:from-blue-400 dark:via-sky-400 dark:to-indigo-400",
  },
  {
    word: "Limits",
    gradientClass: "from-rose-500 via-pink-500 to-red-500 dark:from-rose-400 dark:via-pink-400 dark:to-red-400",
  }
];
...
export function LandingHero() {
  ...
  // Stacked cards layout configuration
  const cards = [
    {
  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-between pt-16 px-2 sm:px-12 md:px-12 lg:px-16 xl:px-24 overflow-hidden">
      ...
      <div className="ml-24 max-w-[88rem] w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center items-start text-left h-full lg:-translate-x-4 xl:-translate-x-8">
          
          {/* Headline */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold tracking-tight text-neutral-900 dark:text-zinc-50 leading-[1.15]  min-h-[130px] sm:min-h-[155px] md:min-h-[180px] lg:min-h-[210px]">
            Collect data.
            <br />
            Without the{" "}
          ...
          {/* Supporting Copy */}
          <p className="text-sm sm:text-base md:text-lg text-neutral-600 dark:text-zinc-400 mb-5 max-w-xl leading-relaxed">
            Seven ways to present a single form. Built-in analytics, 
version history, and submission integrity without 
the bloat of legacy form builders.
          </p>
      ...
      <div className="lg:absolute lg:top-[110px] lg:right-40 z-20 flex justify-center lg:justify-end items-start relative mt-16 lg:mt-0 pb-16 lg:pb-0 pointer-events-none w-full lg:w-auto">
        <div className="pointer-events-auto origin-top lg:origin-top-right scale-50 lg:scale-[0.55] xl:scale-[0.75] 2xl:scale-90">
          <DisplayCards cards={cards} />
        </div>
      </div>

      {/* BOTTOM RIGHT: Marquee Demo */}
      ...
      {/* Styled JSX for primary button shifting gradient animation */}
      <style jsx>{`
