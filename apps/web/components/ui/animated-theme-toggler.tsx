...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      ref={buttonRef}
      onClick={toggleTheme}
      className={cn("flex items-center justify-center text-neutral-600 hover:text-neutral-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors", className)}
      {...props}
    >
