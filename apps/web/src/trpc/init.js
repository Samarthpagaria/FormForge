...
exports.protectedProcedure = exports.baseProcedure = exports.createCallerFactory = exports.createTRPCRouter = exports.createTRPCContext = void 0;
...
var createTRPCContext = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, server_2.auth)()];
            case 1:
                authObject = _a.sent();
                return [2 /*return*/, { auth: authObject, db: db_1.db }];
        }
    });
}); };
...
var isAuthed = t.middleware(function (_a) {
    ...
    if (!((_b = ctx.auth) === null || _b === void 0 ? void 0 : _b.userId)) {
        throw new server_1.TRPCError({ code: "UNAUTHORIZED" });
    }
    return next({
        ctx: {
            // Infers that auth and userId are definitely present in protectedProcedures
            auth: __assign(__assign({}, ctx.auth), { userId: ctx.auth.userId }),
        },
    });
});
