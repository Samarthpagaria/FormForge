...
import { BookOpen, Rocket, Link as LinkIcon, Code, ArrowLeft } from "lucide-react";
...
export default function DocsPage() {
  return (
    <div className="relative z-0 min-h-[calc(100vh-64px-2rem)] bg-[#f5f5f3] dark:bg-zinc-950 flex flex-col p-6 md:px-10 m-4 rounded-[2rem] border border-neutral-200/60 dark:border-zinc-800 shadow-sm overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] bg-[#d9e5c9] dark:bg-emerald-900/20 rounded-full blur-[100px] -z-10 pointer-events-none opacity-60" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-[#e3ecd6] dark:bg-emerald-900/10 rounded-full blur-[120px] -z-10 pointer-events-none opacity-60" />

      {/* Header Area */}
      <div className="mb-8 pb-6 border-b border-dashed border-neutral-300 dark:border-zinc-800">
        <Link href="/dashboard" className="inline-flex items-center text-sm font-medium text-neutral-500 dark:text-zinc-400 hover:text-neutral-900 dark:hover:text-zinc-100 transition-colors mb-4">
          <ArrowLeft size={16} className="mr-2" />
          Back to Dashboard
        </Link>
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-neutral-800 dark:text-zinc-100 tracking-tight">Documentation</h1>
            <p className="text-neutral-500 dark:text-zinc-400 text-sm mt-1">Learn how to build, share, and analyze forms.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl">
        ...
        {/* Getting Started */}
        <div className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-neutral-200/60 dark:border-zinc-800/60 rounded-3xl p-8 shadow-sm">
          <div className="w-12 h-12 bg-violet-100 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 rounded-xl flex items-center justify-center mb-6">
            <Rocket size={24} />
          </div>
          <h2 className="text-xl font-bold text-neutral-800 dark:text-zinc-100 mb-3">Getting Started</h2>
          <p className="text-neutral-600 dark:text-zinc-400 text-sm leading-relaxed mb-4">
        ...
        <div className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-neutral-200/60 dark:border-zinc-800/60 rounded-3xl p-8 shadow-sm">
          ...
          <h2 className="text-xl font-bold text-neutral-800 dark:text-zinc-100 mb-3">Creating a Form</h2>
          <p className="text-neutral-600 dark:text-zinc-400 text-sm leading-relaxed mb-4">
        ...
        <div className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-neutral-200/60 dark:border-zinc-800/60 rounded-3xl p-8 shadow-sm">
          ...
          <h2 className="text-xl font-bold text-neutral-800 dark:text-zinc-100 mb-3">Sharing & Publishing</h2>
          <p className="text-neutral-600 dark:text-zinc-400 text-sm leading-relaxed mb-4">
